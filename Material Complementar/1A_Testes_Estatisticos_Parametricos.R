...
# Como W tem 3000 linhas nao é possivel utilizar o teste de Shapiro Wilks,
# portanto vou utilizar o teste KS

ks.test(W, "pnorm", mean(W), sd(W))

hist(W)

# Analisando o resultado do teste e a o histograma, podemos concluir com 95%
# de confiança a hipotese nula foi rejeitada
...
leveneTest(x ~ grupo, data = var2)

variancia2 %>%
  ggplot() +
  geom_boxplot(aes(x = grupo, y = x))
